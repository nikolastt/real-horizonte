...
export default function EmailSignContract({ name }: Props) {
          ...
          <Container className="mx-auto bg-white px-6 font-sans">
            <Section className=" p-10">
              <Img
                className="mx-auto"
                width={200}
                src="https://real-horizonte.vercel.app/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Flogo-seguro.ce1f35de.png&w=256&q=75"
              />
            </Section>

            <h1 className="text-[3rem] mt-6">
              Assinatura realizada com sucesso
            </h1>

            <Section className="text-black ">
              <Text className="text-lg">Olá, {name}</Text>
            ...
            <Section className="text-center mt-6">
              <Button
                href="https://real-horizonte.vercel.app/app/docs"
                className="bg-[#0e1225] rounded-lg  text-white px-6 py-2 hover:bg-primary/50 transition-all ease-linear"
              >
                Meus Documentos
              </Button>
            </Section>
